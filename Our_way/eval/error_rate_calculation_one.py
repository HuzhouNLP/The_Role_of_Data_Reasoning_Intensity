...
config = {
    # 基础路径配置（仅用于第一步数据合并）
    "base_path": r"F:\合成数据数据集\pythonProject\all_data_experiment_36788\experiment_processing\random1_test_4.3",
    # 公共文件夹名称
    "common_folder_name": "score_final_data_36788_gpt_correct_sig_no_eval_epoch_16_all_test_again_original_way_do_sample",
    # JSONL 文件名称
    "jsonl_file_name": "generated_predictions.jsonl",
    # 分数源文件（需放在当前目录）
    "source_score_file": "all_test_data_sig_80_random1.json",
    # 分析配置
